...
//     |--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------|
        KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_VOLU,          MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR, ZOOM_IN,
//     |--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------|
        KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_VOLD,          MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, ZOOM_OUT,
//     |--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------|
...
//     |--------+--------+--------+--------+--------|       |--------+--------+--------+--------+--------|
        KC_ASTR, KC_4,    KC_5,    KC_6,    KC_PLUS,         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
//     |--------+--------+--------+--------+--------|       |--------+--------+--------+--------+--------|
